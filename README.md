...
1. You can run the [Setting Up the Lab Environment](/docs/getting-started/setting-up-lab-environment)

2. You can run the [Kubernetes the Easy Way with AKS Automatic](/docs/getting-started/aks-automatic)
