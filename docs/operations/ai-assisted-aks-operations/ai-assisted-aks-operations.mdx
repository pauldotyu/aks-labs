...
| **Agent Instructions**            | Accept the default instructions provided, but insert the following additional bullet points at the top of the instruction section:<br/><br/><ul><li>When troubleshooting, start troubleshooting from within the cluster using AKS MCP or kubernetes tooling you have access to.</li><li>Use AKS MCP tools wherever possible and delegate tasks to appropriate agents when necessary.</li><li>You have full permission to the Azure resource group &lt;INSERT_YOUR_RESOURCE_GROUP_NAME&gt; and all the resources within it.</li></ul><br/>NOTE: If your agent isn't behaving the way you expect it to, you can adjust the instructions or settings as needed. |
...
| **Skills**                        | Add `ghcr.io/pauldotyu/aks-skills:latest` for the model to leverage pre-built skills for AKS operations.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |

Confirm all the details are correct, then scroll to the bottom of the page and select **Create Agent** to deploy the agent.

![Create the aks-agent in kagent](./kagent-add-aks-agent.png)
