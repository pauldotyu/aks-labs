...
```bash
curl -fsSL https://raw.githubusercontent.com/pauldotyu/aks-labs/refs/heads/ai_assisted_ops/docs/operations/assets/ai-assisted-aks-operations/setup-cluster-issues.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/pauldotyu/aks-labs/refs/heads/ai_assisted_ops/docs/operations/assets/ai-assisted-aks-operations/cleanup-cluster-issues.sh | bash
```
