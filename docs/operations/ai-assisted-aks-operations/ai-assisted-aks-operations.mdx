...
sidebar_label: AI Agents and MCP
sidebar_position: 1
---
...
```bash
curl -fsSL https://raw.githubusercontent.com/pauldotyu/aks-labs/0f7a8b410be0b39657d313a6f2bbf0dd1ef50743/docs/operations/ai-assisted-aks-operations/setup-cluster-issues.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/pauldotyu/aks-labs/0f7a8b410be0b39657d313a6f2bbf0dd1ef50743/docs/operations/ai-assisted-aks-operations/cleanup-cluster-issues.sh | bash
```
