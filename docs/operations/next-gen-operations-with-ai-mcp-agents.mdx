...
- **Agent Instructions**: Accept the default instructions provided. (TODO: tell it to troubleshoot from the cluster level first, then move to Azure APIs, and to always use tools for diagnostics and never guess without data. You can find the full system prompt in this [gist](https://gist.github.com/pauldotyu/aks-agent-system-prompt))
...
```prompt
I seem to be unable to unable to access the store-front application deployed in the pets namespace. Can you investigate this potential networking issue?
```
