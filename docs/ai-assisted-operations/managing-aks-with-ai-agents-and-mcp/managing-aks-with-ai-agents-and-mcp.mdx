...
```bash
curl -fsSL https://raw.githubusercontent.com/pauldotyu/aks-labs/d05f3fbaf11f1d3355ace6dda51b1d7641abf9d9/docs/ai-assisted-operations/managing-aks-with-ai-agents-and-mcp/setup-cluster-issues.sh | bash
```

:::danger TODO: Replace temporary instructions

UPDATE ONCE PR REVIEW IS COMPLETED
...
```bash
curl -fsSL https://raw.githubusercontent.com/pauldotyu/aks-labs/d05f3fbaf11f1d3355ace6dda51b1d7641abf9d9/docs/ai-assisted-operations/managing-aks-with-ai-agents-and-mcp/cleanup-cluster-issues.sh | bash
```
...
- The custom `ai-service` Deployment and ServiceAccount
