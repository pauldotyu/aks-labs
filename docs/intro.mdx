  ...
  <article className="margin-top--lg">
    <section className="row list">
        <article className="col col--6 margin-bottom--lg">
          ...
          href="/aks-labs/docs/getting-started/k8s-aks-fundamentals">
        ...
        <article className="col col--6 margin-bottom--lg">
          ...
          href="/aks-labs/docs/networking/istio-lab">
            ...
            <p className="cardDescription">
              Learn how to implement service discovery on Azure Kubernetes Service (AKS) using Istio Service Mesh. </p>
          </a>
        </article>
    </section>
  </article>
