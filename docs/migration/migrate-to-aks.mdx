...
--client-type none \
--kube-namespace default | tee sc.json
```
...
The Containerization Assist MCP Server will scan your project and conteinerize your application. It will elaborate on a strategy on how to do this which will involve:
...
If needed, you can retrieve the Service Connector account name from your `k8s/sc.json` file.
