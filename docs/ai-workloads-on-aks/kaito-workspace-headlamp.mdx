...
- [NCasT4_v3 series](https://learn.microsoft.com/azure/virtual-machines/sizes/gpu-accelerated/ncast4v3-series?tabs=sizebasic) GPU VMs
- [NVadsA10_v5 series](https://learn.microsoft.com/azure/virtual-machines/sizes/gpu-accelerated/nvadsa10v5-series?tabs=sizebasic) GPU VMs

**No GPU quota available?** You'll need to [request additional quota](https://learn.microsoft.com/azure/quotas/quickstart-increase-quota-portal) from Azure support before proceeding.
